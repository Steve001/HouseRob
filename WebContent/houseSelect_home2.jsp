		...
		<div class="row-fluid">
			<div class="span2 bs-docs-sidebar" >
				<ul class="nav nav-list bs-docs-sidenav">
					...
					<li><a href="houseSelect?action=floorList2&house_floor='17F'"><i class="icon-chevron-right"></i>17楼</a></li>
					<li><a href="houseSelect?action=floorList2&house_floor='16F'"><i class="icon-chevron-right"></i>16楼</a></li>
					<li><a href="houseSelect?action=floorList2&house_floor='15F'"><i class="icon-chevron-right"></i>15楼</a></li>
					<li><a href="houseSelect?action=floorList2&house_floor='14F'"><i class="icon-chevron-right"></i>14楼</a></li>
					<li><a href="houseSelect?action=floorList2&house_floor='13F'"><i class="icon-chevron-right"></i>13楼</a></li>
					<li><a href="houseSelect?action=floorList2&house_floor='12F'"><i class="icon-chevron-right"></i>12楼</a></li>
					<li><a href="houseSelect?action=floorList2&house_floor='11F'"><i class="icon-chevron-right"></i>11楼</a></li>
					<li><a href="houseSelect?action=floorList2&house_floor='10F'"><i class="icon-chevron-right"></i>10楼</a></li>
					<li><a href="houseSelect?action=floorList2&house_floor='9F'"><i class="icon-chevron-right"></i>9楼</a></li>
					<li><a href="houseSelect?action=floorList2&house_floor='8F'"><i class="icon-chevron-right"></i>8楼</a></li>
					<li><a href="houseSelect?action=floorList2&house_floor='7F'"><i class="icon-chevron-right"></i>7楼</a></li>
					<li><a href="houseSelect?action=floorList2&house_floor='6F'"><i class="icon-chevron-right"></i>6楼</a></li>
					<li><a href="houseSelect?action=floorList2&house_floor='5F'"><i class="icon-chevron-right"></i>5楼</a></li>
					<li><a href="houseSelect?action=floorList2&house_floor='4F'"><i class="icon-chevron-right"></i>4楼</a></li>
					<li><a href="houseSelect?action=floorList2&house_floor='3F'"><i class="icon-chevron-right"></i>3楼</a></li>
					<li><a href="houseSelect?action=floorList2&house_floor='2F'"><i class="icon-chevron-right"></i>2楼</a></li>
